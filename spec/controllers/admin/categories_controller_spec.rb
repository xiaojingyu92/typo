...
describe Admin::CategoriesController do
  ...
  describe "test_create" do
    ...
    it "shoud create new category" do
      post:new, :category => {:name => "Software Engineering", :keywords => "Software", :permalink => "Tech"}
      assert_response :redirect, :action=> "index"
  ...
  describe "test_edit" do
    ...
    it "shoud edit category" do
      post:edit, :category => {:name => "Software Engineering", :keywords => "Software", :permalink => "Tech"}
      assert_response :redirect, :action=> "index"
      expect(assigns(:category)).not_to be_nil
      expect(flash[:notice]).to eq("Category was successfully saved.")
    end
